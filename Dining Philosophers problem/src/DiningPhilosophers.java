...
class Philosopher implements Runnable {
    ...
    //To create a common method to simulate all actions (thinking, acquiring left fork, acquiring right fork , eating, putting down left fork,putting down right fork )
